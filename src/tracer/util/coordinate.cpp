...
Coordinate3& Coordinate3::Set_Translation(const double& x,
                                          const double& y,
                                          const double& z) {
  return Set_Translation(MatrixTransformation::Translate(x, y, z));
}

Coordinate3& Coordinate3::Set_Rotation(const double& x,
                                       const double& y,
                                       const double& z) {
...
Coordinate3& Coordinate3::Set_Scale(const double& x,
                                    const double& y,
                                    const double& z) {
  return Set_Scale(MatrixTransformation::Scale(Vector3{x, y, z}));
}

MatrixTransformation Coordinate3::AlignXYZ(const Vector3& i,
                                           const Vector3& j,
                                           const Vector3& k) {
