...
// namespace{
//   std::shared_ptr<Material> CreateLambertian(const std::vector<Attribute>&
//   attributes){
...
//   const bool lambertian_registered =
//   MaterialFactory::Instance()->Register(Lambertian_MaterialID,
//   CreateLambertian);
// }
