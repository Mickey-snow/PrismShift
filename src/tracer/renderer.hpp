...
//     void Set_Samples_per_pixel(const int& samples){ samples_per_pixel =
//     samples; } void Set_Max_recurrent_depth(const int& max_recur){
//     max_recurrent_depth = max_recur; } void Set_Preview_switch(const bool&
//     show_preview){ show_preview_window = show_preview; } void
//     Set_Threads(const int& threads){ max_threads = threads; }
//   private:
