...
TEST(MatrixTest, RREF) {
  ...
  {
    Matrix<3, 6> mat{0,  3, -6, 6, 4,  -5, 3,  -7, 8,
                     -5, 8, 9,  3, -9, 12, -9, 6,  15};

    Matrix<3, 6> reduced{1, 0, -2, 3, 0, -24, 0, 1, -2,
                         2, 0, -7, 0, 0, 0,   0, 1, 4};
  ...
  {
    Matrix<3, 6> mat{1, 0, -2, 3, 0, -24, 0, 1, -2, 2, 0, -7, 0, 0, 0, 0, 1, 4};
    auto reduced = mat;
    EXPECT_EQ(mat.rref(), reduced);
  }
  {
...
TEST(MatrixTest, Inverse) {
  ...
  {
    Matrix<2, 2> mat{1, 2, 3, 4};
    Matrix<2, 2> expected{-2, 1, 3.0 / 2, -1.0 / 2};
